...
SoundJao permite baixar músicas e playlists diretamente do SoundCloud, adicionando metadados e capas automaticamente.
...
```sh
git clone https://github.com/JaoPred0/SoundJao.git
```
